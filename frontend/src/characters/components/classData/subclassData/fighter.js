  ...
  '5e': {
    ...
    'Rune Knight': {
      ...
      features: [
        ...
        { level: 3, name: 'Rune Carving', description: 'You can carve runes onto objects you wear or hold, one rune per object. You know two runes to start, and learn another at levels 7, 10 and 15 (five in all); each time you gain a Fighter level you can replace one rune you know. Cloud, Fire, Frost and Stone runes are available to you now; the Hill rune requires level 7 and the Storm rune level 15. Each rune grants a passive benefit while carved, plus a Channel Rune effect you can invoke once per short or long rest. The save DC for a rune is 8 + your proficiency bonus + your Constitution modifier.' },
        { level: 3, name: 'Giant\'s Might', description: 'As a bonus action, magically grow to Large size for 1 minute (if you are smaller than Large), along with anything you are wearing. While it lasts, you have advantage on Strength checks and Strength saving throws, and once on each of your turns one of your attacks with a weapon or an unarmed strike deals an extra 1d6 damage on a hit. Use this a number of times equal to your PB per long rest.' },
        ...
        { level: 18, name: 'Runic Juggernaut', description: 'Your rune magic and your body have become one. When you use Giant\'s Might, you can grow to Huge size (instead of Large), your extra damage increases to 1d10, and while you are Huge your reach increases by 5 feet.' },
      ],
    },
    'Samurai': {
