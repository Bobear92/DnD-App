  ...
  '5e': {
    ...
    'Arcane Archer': {
      ...
      features: [
        ...
        { level: 10, name: 'Additional Arcane Shot', description: 'You learn an additional Arcane Shot option. You also get one more use of Arcane Shot per rest.' },
        ...
        { level: 18, name: 'Superior Arcane Shot', description: 'Each of your Arcane Shot options gains improved effects at this level, increasing their damage and power.' },
      ],
    },
    'Cavalier': {
      ...
      features: [
        ...
        { level: 3, name: 'Unwavering Mark', description: 'When you hit a creature with a melee attack, you can mark it until the end of your next turn. You deal extra damage equal to half your proficiency bonus on the next attack against a marked creature. If a marked creature deals damage to anyone other than you, you can use a bonus action to attack it once with advantage.' },
        { level: 7, name: 'Warding Maneuver', description: 'When you or a creature you can see within 5 ft is hit by an attack, you can use your reaction to roll a d8 and add the number to the target\'s AC. If the attack still hits, the attacker takes 1d8 force damage. Use this a number of times equal to your CON modifier per long rest.' },
        ...
        { level: 18, name: 'Vigilant Defender', description: 'You respond to danger with extraordinary vigilance. In combat, you get a special reaction that you can take once on every creature\'s turn (except your turn), allowing you to make opportunity attacks without provoking opportunity attacks yourself.' },
      ],
    },
    'Echo Knight': {
      ...
      features: [
        ...
        { level: 7, name: 'Echo Avatar', description: 'You can temporarily transfer your consciousness to your echo. As an action, see through the echo\'s eyes and hear through its ears for up to 10 minutes (concentration). Your body is deafened and blinded during this time.' },
        { level: 10, name: 'Shadow Martyr', description: 'As a reaction when a friendly creature you can see within your echo\'s range is attacked, you can have the attack instead target your echo and place the echo in the attacked creature\'s space. The attack targets your echo instead.' },
        ...
        { level: 18, name: 'Legion of One', description: 'You can use Manifest Echo to create two echoes with the same bonus action, and each one can unleash a Unleash Incarnation attack. If you\'re targeted by an effect requiring a saving throw, only one echo is automatically destroyed (not both).' },
      ],
    },
    'Psi Warrior': {
