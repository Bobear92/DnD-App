...
export default function BarbarianSheet({ data = {}, onChange, readOnly = false, level = 1, creation = false, scores = {}, backgroundSkills = [], raceSkills = [], section = 'all', acExtra = null, maxHpNode = null }) {
