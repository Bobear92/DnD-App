 ...
 * d8, full caster, Bardic Inspiration, Expertise, Jack of All Trades, Bard College subclass.
 */
...
export default function BardSheet({ data = {}, onChange, readOnly = false, level = 1 }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Expertise */}
      <Field label="Expertise (double proficiency — choose 2, then 4 at level 6)">
        {readOnly ? (
